  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/login/doctorant" element={<Login role='doctorant' title='Espace Doctorant' subtitle=' Accédez à votre espace pour suivre l’avancement de votre thèse et gérer vos livrables. '  />} />
        <Route path="/login/encadrant" element={<Login  role='encadrant' title='Espace Encadrant' subtitle=' Supervisez les doctorants, consultez les travaux et suivez les réunions d’encadrement.' />} />
        <Route path="/login/responsable" element={<Login role='responsable' title='Espace Responsable' subtitle='Consultez les indicateurs globaux et suivez l’état d’avancement des doctorants.' />} />
        <Route path="/login/admin" element={<Login role='admin' title='Espace Admin' subtitle='Gérez les utilisateurs, les rôles et les paramètres de la plateforme.' />} />
        <Route path="/forgot" element={<ForgotPassword />} />
        <Route path="/login/co-encadrant" element={<Login role='co-encadrant' title='Espace Co-Encadrant'subtitle='Consultez les doctorants co-encadrés, suivez les réunions et participez au suivi scientifique.'/>}/>
