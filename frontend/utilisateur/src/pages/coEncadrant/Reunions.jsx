...
import {
  CalendarIcon, ClockIcon, UsersIcon,
...
const CoReunions = () => {
  ...
  useEffect(() => {
    ...
    if (!user) return
    fetch(`http://localhost:3001/api/coencadrant/reunions/${user.id}`)
      .then(res => res.json())
  ...
  return (
    <div className="p-6 space-y-5 max-w-5xl mx-auto">
      ...
      <div>
        ...
        <p className="text-sm text-slate-500">Réunions des doctorants co-encadrés</p>
      </div>
